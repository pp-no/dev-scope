...
// 開発環境や API 障害時でも画面を確認できるよう、代替データを用意しておく。
const fallbackVideos: Video[] = [
  {
    id: "dQw4w9WgXcQ",
    youtubeId: "dQw4w9WgXcQ",
    title: "Next.js App Router の設計を見直す実践ポイント",
    summary: "ルーティング、サーバーコンポーネント、キャッシュ戦略を整理しながら、実務で破綻しにくい構成を学べる動画。",
    description: "ルーティング、サーバーコンポーネント、キャッシュ戦略を整理しながら、実務で破綻しにくい構成を学べる動画。",
    category: "frontend",
  ...
  },
  {
    ...
    summary: "Anthropic の Claude 3.7 を使って、コードを書き・実行し・自己修正する自律型エージェントを TypeScript でゼロから実装します。",
    description: "Anthropic の Claude 3.7 を使って、コードを書き・実行し・自己修正する自律型エージェントを TypeScript でゼロから実装します。Tool Use API の最小構成から並列ツール呼び出し、コスト最適化まで解説。",
    category: "ai",
    categoryLabel: "AI活用",
  ...
  },
  {
    ...
    summary: "PostgreSQL 17 で追加された主要機能を実例とともに解説。実際の移行作業で遭遇したトラブルと対処法を紹介します。",
    description: "PostgreSQL 17 で追加された主要機能を実例とともに解説。実際の移行作業で遭遇したトラブルと対処法を紹介します。",
    category: "backend",
  ...
  },
  {
    ...
    summary: "自己管理の Kubernetes から Cloud Run / ECS マネージドへ移行した実例。判断基準とコスト比較を詳しく解説。",
    description: "自己管理の Kubernetes から Cloud Run / ECS マネージドへ移行した実例。判断基準とコスト比較を詳しく解説。",
    category: "infra",
    categoryLabel: "インフラ",
  ...
  },
  {
    ...
    summary: "GitHub Copilot Workspace の実際の使用感、得意なこと・不得意なこと、チームへの導入方法をレビュー。",
    description: "GitHub Copilot Workspace の実際の使用感、得意なこと・不得意なこと、チームへの導入方法をレビュー。",
    category: "tooling",
    categoryLabel: "開発ツール",
  ...
  },
  {
    ...
    summary: "RSC の概念から実際のプロジェクト導入まで。ハマりやすいポイントと回避策を 5 つに絞って解説します。",
    description: "RSC の概念から実際のプロジェクト導入まで。ハマりやすいポイントと回避策を 5 つに絞って解説します。",
    category: "frontend",
    categoryLabel: "フロントエンド",
  ...
  },
  {
    ...
    summary: "Tailwind CSS v4 の新機能と CSS @layer を組み合わせた設計パターンを実プロジェクトで検証。",
    description: "Tailwind CSS v4 の新機能と CSS @layer を組み合わせた設計パターンを実プロジェクトで検証。",
    category: "frontend",
    categoryLabel: "フロントエンド",
  ...
  },
  {
    ...
    summary: "生成 AI の台頭で変化するエンジニアリングの役割。これからのキャリアで求められるスキルを体系的に整理。",
    description: "生成 AI の台頭で変化するエンジニアリングの役割。これからのキャリアで求められるスキルを体系的に整理。",
    category: "career",
...
export async function getHomeVideos() {
  ...
  try {
    const videos = await searchYouTubeVideos("Webエンジニア 技術 動画", 12);
